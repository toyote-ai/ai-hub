...
export default function RootLayout({
  ...
  // 💡 Vercelの環境変数からプロデューサーの本物ID（ca-pub-3920807823182537）を自動で読み込みます
  ...
  return (
    <html lang="ja">
      {/* 💡 致命的バグ修正：next/scriptを完全に廃止し、生htmlの標準scriptタグをheadに直植えすることで、初期HTMLに確実にコードをのせ、Googleのクローラーを通過させます */}
      <head>
        <script
          async
